...
Every activation that preserves contents different from the declaration reports
`LOCAL CHANGES` on stderr. A clean combination of live and declarative edits
